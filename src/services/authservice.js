...
export function getToken() {
    if (!localStorage.getItem('pausework-info') && !localStorage.getItem('majasave-token')) {
        return null;
    }
    else {
        const isAdmin = localStorage.getItem('pausework-info');
        const token = localStorage.getItem('majasave-token');
...
export function verifyUser() {
    try {
        return localStorage.getItem('majasave-token');
    } catch (error) {
...
export function removeToken() {
    localStorage.removeItem('majasave-token');
